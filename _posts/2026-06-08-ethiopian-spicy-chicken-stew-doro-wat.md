...
This recipe traditionally uses a whole, cut-up chicken, but I use a mix of boneless, skinless chicken thighs and breasts. I cook the whole thing in an Instant Pot for convenience, but it can also be done in a slow cooker, after the onions are caramelized. Serve it with [injera]({% post_url "2026-06-05-quick-ethiopian-flatbread-injera" %}) and [cabbage and carrots]({% post_url "2026-06-07-ethiopian-cabbage-carrots" %}) for a complete meal.
...
1. Remove lid and set to sauté mode. Stir aggressively to break up chicken and allow sauce to thicken slightly. Turn off heat.
1. If using, add hard-boiled eggs and let sit for about 5 minutes until heated through.
1. Squeeze lime juice over top and stir gently. Adjust seasoning to taste. Serve on injera.
